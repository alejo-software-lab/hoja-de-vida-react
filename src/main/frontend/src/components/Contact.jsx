    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className={`lg:col-span-5 space-y-8 flex flex-col justify-between transition-all duration-700 delay-200 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-850 hover:border-indigo-500 hover:scale-[1.02] hover:shadow-lg transition-all duration-300 group"
                >
                  <div className="w-12 h-12 rounded-xl bg-indigo-100 dark:bg-indigo-950/55 text-indigo-600 dark:text-indigo-450 flex items-center justify-center group-hover:bg-indigo-600 group-hover:text-white group-hover:scale-110 transition-all duration-300">
                ...
                {/* Location */}
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-850 hover:scale-[1.02] hover:shadow-lg transition-all duration-300">
                ...
                <a
                  ...
                  className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-850 hover:border-emerald-500 hover:scale-[1.02] hover:shadow-lg transition-all duration-300 group"
                >
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-850 text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:scale-110 hover:-rotate-6 hover:shadow-lg transition-all duration-300"
                  aria-label="LinkedIn"
                >
          ...
          {/* Right - Contact Form */}
          <div className={`lg:col-span-7 transition-all duration-700 delay-300 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}>
            <div className="p-6 sm:p-10 rounded-3xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-850 shadow-sm relative hover:shadow-xl transition-shadow duration-500">
              ...
              {submitSuccess && (
                <div className="absolute inset-0 bg-white dark:bg-slate-950 rounded-3xl z-20 flex flex-col items-center justify-center text-center p-6 animate-fade-in border border-emerald-500/20">
                  <div className="w-16 h-16 rounded-full bg-emerald-150 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-450 flex items-center justify-center mb-4 animate-bounce">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3.5 rounded-2xl bg-white dark:bg-slate-950 border text-slate-850 dark:text-white placeholder-slate-400 dark:placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:scale-[1.01] transition-all duration-300 ${
                        errors.name
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3.5 rounded-2xl bg-white dark:bg-slate-950 border text-slate-850 dark:text-white placeholder-slate-400 dark:placeholder-slate-650 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:scale-[1.01] transition-all duration-300 resize-none ${
                      errors.message
                        ? "border-rose-500 animate-shake"
                        : "border-slate-200 dark:border-slate-850 focus:border-indigo-550"
                    }`}
