...
const Projects = () => {
  return (
    <section id="proyectos" className="py-24 bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
        ...
        <ScrollReveal>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900/55 text-indigo-600 dark:text-indigo-400 text-sm font-semibold mb-3">
              <FolderGit2 className="w-4 h-4" /><span>Portafolio</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">Mis Proyectos</h2>
            <p className="text-slate-500 dark:text-slate-400 mt-3">Explora todos mis proyectos en GitHub.</p>
          ...
          <div className="flex justify-center">
            <a href="https://github.com/alejo-software-lab" target="_blank" rel="noreferrer"
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold text-slate-850 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-450 transition-colors mb-2">alejo-software-lab</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed">Visita mi perfil de GitHub para ver todos mis repositorios y proyectos open source.</p>
              </div>
              <span className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold shadow-lg shadow-indigo-600/20 group-hover:scale-110 group-hover:shadow-indigo-600/40 transition-all duration-300">
                <GithubIcon className="w-5 h-5" /><span>Ver en GitHub</span><ExternalLink className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </span>
            </a>
          </div>
        </ScrollReveal>
